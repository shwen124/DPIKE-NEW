...
from ..models.memoedit import apply_memoedit_to_model # new!
...
from ..models.r_rome import R_ROMEHyperParams, apply_r_rome_to_model # new!
from ..models.regularizedmemit import apply_regularizedmemit_to_model, apply_lambdamemit_to_model # new!
...
ALG_DICT = {
    ...
    'memoedit': apply_memoedit_to_model, ### new!
    'R-ROME': apply_r_rome_to_model, ### new!
    'regularizedMEMIT': apply_regularizedmemit_to_model, ##new!
    'lambdamemit': apply_lambdamemit_to_model, ##new!
