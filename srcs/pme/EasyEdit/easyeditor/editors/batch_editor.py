...
class BatchEditor(Enum):
    ...
    MEMIT = 'MEMIT'
    memoedit = 'memoedit'
    REGULARIZEDMEMIT = 'regularizedMEMIT'
    lambdamemit = 'lambdamemit'
    PMET = 'PMET'
    FT = 'FT'
    LoRA = 'LoRA'
    ...
    def is_batchable_method(alg_name: str):
        return alg_name == BatchEditor.CALINET.value \
            ...
            or alg_name == BatchEditor.memoedit.value \
            or alg_name == BatchEditor.REGULARIZEDMEMIT.value \
            or alg_name == BatchEditor.lambdamemit.value \
