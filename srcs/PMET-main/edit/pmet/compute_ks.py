...
from util.request_context import format_contexts_for_requests
...
def _context_templates_for_requests(requests, context_templates):
    return format_contexts_for_requests(requests, context_templates)
...
def compute_ks_parallel(
    ...
    contexts = _context_templates_for_requests(requests, context_templates)
